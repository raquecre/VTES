const Header = props => {
    ...
    return (
        ...
        <div className="font-bold text-3xl bg-black text-white items-center p-5
        grid justify-center 2xl:grid-cols-3 xl:grid-cols-3 lg:grid-cols-3 sm:grid-cols-1 xs:grid-cols-1">

            <div className="rounded-full p-5 flex justify-center w-[150px]">
                <img src="https://i.imgur.com/jZVFkpm.png" alt=""  />
            </div>
             <p>{nameCommunity}</p> 
